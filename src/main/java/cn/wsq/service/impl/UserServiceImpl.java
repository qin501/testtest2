...
import cn.wsq.enums.MsgActionEnum;
import cn.wsq.enums.MsgSignFlagEnum;
import cn.wsq.enums.SearchFriendsStatusEnum;
import cn.wsq.mapper.*;
import cn.wsq.nettyServer.ChatMsg;
import cn.wsq.nettyServer.DataContent;
import cn.wsq.nettyServer.UserChannelRel;
import cn.wsq.pojo.FriendsRequest;
import cn.wsq.pojo.MyFriends;
...
public class UserServiceImpl implements UserService {
    ...
    public String saveMsg(ChatMsg chatMsg) {
        ...
        cn.wsq.pojo.ChatMsg msgDB = new cn.wsq.pojo.ChatMsg();
    ...
    @Transactional(propagation = Propagation.SUPPORTS)
    @Override
    public List<cn.wsq.pojo.ChatMsg > getUnReadMsgList(String acceptUserId) {

        Example chatExample = new Example(cn.wsq.pojo.ChatMsg.class);
        Example.Criteria chatCriteria = chatExample.createCriteria();
        chatCriteria.andEqualTo("signFlag", 0);
        chatCriteria.andEqualTo("acceptUserId", acceptUserId);

        List<cn.wsq.pojo.ChatMsg > result = chatMsgMapper.selectByExample(chatExample);
        return result;
    }
